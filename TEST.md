...
Compared to other minifier packages for ST `Minify` is very light: the plugin itself is less than 170 lines of Python code.
...
Which 3rd party program is being used by `Minify`
-------------------------------------------------
